...
<head>
    ...
    <title>New email template 2022-04-30</title>
...
<body
    ...
    <div class="es-wrapper-color" style="background-color:#F4F4F4">
        ...
        <table class="es-wrapper"
            ...
            <tbody>
                <tr class="gmail-fix" style="border-collapse:collapse" height="0">
                                ...
                                <tr style="border-collapse:collapse">
                                    <td cellpadding="0" cellspacing="0" border="0"
                                        style="padding:0;Margin:0;line-height:1px;min-width:600px" height="0"><img
                                            src="https://weirjy.stripocdn.email/content/guids/CABINET_837dc1d79e3a5eca5eb1609bfe9fd374/images/41521605538834349.png"
                ...
                <tr style="border-collapse:collapse">
                    <td style="padding:0;Margin:0" valign="top">
                                ...
                                <tr style="border-collapse:collapse">
                                    <td style="padding:0;Margin:0;background-color:#ffffff" bgcolor="#ffffff"
                                        ...
                                        <table class="es-header-body"
                                            ...
                                            <tbody>
                                                <tr style="border-collapse:collapse">
                                                    <td style="Margin:0;padding-bottom:10px;padding-left:10px;padding-right:10px;padding-top:20px"
                                                        align="left">
                                                        <table
                                                            ...
                                                            <tbody>
                                                                <tr style="border-collapse:collapse">
                                                                    <td style="padding:0;Margin:0;width:580px"
                                                                                    ...
                                                                                    <td style="padding:0;Margin:0;font-size:0px"
                                                                                        align="center"><a
                                                                                            ...
                                                                                            style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#111111;font-size:14px"><img
                                                                                                class="adapt-img"
                                                                                                src="https://weirjy.stripocdn.email/content/guids/CABINET_dccbf2828f8928aa7d72703ee28a964b/images/120042555_1981936215276848_6086283944840000151_n.jpg"
                                                                                                alt
                        ...
                        <table class="es-content"
                            ...
                            <tbody>
                                <tr style="border-collapse:collapse">
                                    <td style="padding:0;Margin:0;background-color:#39b755" bgcolor="#39B755"
                                        align="center">
                                                                ...
                                                                <tr style="border-collapse:collapse">
                                                                    <td style="padding:0;Margin:0;width:600px"
                                                                        ...
                                                                        <table
                                                                            ...
                                                                            <tbody>
                                                                                <tr style="border-collapse:collapse">
                                                                                    <td style="padding:0;Margin:0;padding-left:30px;padding-right:30px"
                                                                                        class="esd-text" align="center">
                                                                                        <h1
                                                                                ...
                                                                                <tr style="border-collapse:collapse">
                                                                                    <td class="es-m-txt-l esd-text"
                                                                                        ...
                                                                                        <p
                                                                                            ...
                                                                                            Zumaridi account has been
                                                                                            successfully changed. If you
                                                                ...
                                                                <tr style="border-collapse:collapse">
                                                                    <td style="padding:0;Margin:0;width:600px"
                                                                        ...
                                                                        <table
                                                                            ...
                                                                            <tbody>
                                                                                <tr style="border-collapse:collapse">
                                                                                    <td style="padding:0;Margin:0;padding-top:30px;padding-left:30px;padding-right:30px"
                                                                                        class="esd-text" align="center">
                                                                                        <h3
                                                                                ...
                                                                                <tr style="border-collapse:collapse">
                                                                                    <td esdev-links-color="#ffa73b"
                                                                                        style="padding:0;Margin:0;padding-bottom:30px;padding-left:30px;padding-right:30px"
                                                                                        align="center"><a
                                                                                            target="_blank"
                                                                                            href="https://usafrikagov.com/"
                                                                                            style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#39b755;font-size:18px">We’re
